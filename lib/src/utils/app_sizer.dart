...
const num _figmaWidth = 393;
const num _figmaHeight = 852;
const num _figmaStatusBar = 0;
...
class SizeUtils {
  ...
  static void setScreenSize(
    ...
    if (orientation == Orientation.portrait) {
      width = boxConstraints.maxWidth.isNonZero(defaultValue: _figmaWidth);
      height = boxConstraints.maxHeight.isNonZero();
    } else {
      width = boxConstraints.maxHeight.isNonZero(defaultValue: _figmaWidth);
...
extension ResponsiveExtension on num {
  ...
  double get h => ((this * _width) / _figmaWidth);

  /// This method is used to set padding/margin (for the top and bottom side) &
  /// height of the screen or widget according to the Viewport height.
  double get v => (this * _height) / (_figmaHeight - _figmaStatusBar);
